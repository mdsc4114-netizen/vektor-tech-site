...
export default function ProfissionaisLiberais() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-[#0A2540] mb-6">
                Organize seu negócio e atraia mais clientes
              </h1>
              <p className="text-xl text-[#2563EB] font-semibold mb-4">
                Você perde clientes por falta de organização e acompanhamento?
              </p>
              <p className="text-lg text-gray-700 mb-8">
                Automatize agendamentos, organize atendimentos e implemente estratégias de captação. Mais clientes, menos caos administrativo.
              </p>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0A2540] text-center mb-12">
              Os desafios dos profissionais liberais
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                {
                  titulo: 'Agenda desorganizada',
                  descricao: 'Dificuldade em gerenciar agendamentos e acompanhar clientes',
                },
                {
                  titulo: 'Perda de oportunidades',
                  descricao: 'Clientes potenciais não retornam por falta de follow-up',
                },
                {
                  titulo: 'Crescimento limitado',
                  descricao: 'Dificuldade em escalar o negócio sem aumentar a carga de trabalho',
                },
              ].map((item, i) => (
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="container">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0A2540] text-center mb-12">
              Nossas soluções para profissionais liberais
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                {
                  titulo: 'Automação de Agendamentos',
                  descricao: 'Sistema inteligente que organiza sua agenda e confirma compromissos',
                },
                {
                  titulo: 'CRM Personalizado',
                  descricao: 'Gerencie clientes, histórico de atendimentos e comunicação',
                },
                {
                  titulo: 'Funil de Captação',
                  descricao: 'Estratégia automatizada para atrair e converter novos clientes',
                },
                {
                  titulo: 'Follow-up Automático',
                  descricao: 'Mantenha contato com clientes sem esforço manual',
                },
              ].map((item, i) => (
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              {[
                'Agenda 100% organizada e sem conflitos',
                'Aumento de 40% em novos clientes por mês',
                'Redução de 80% em tarefas administrativas',
                'Melhor experiência do cliente com follow-up automático',
                'Crescimento escalável sem aumentar carga de trabalho',
              ].map((benefit, i) => (
              ...
              {[
                {
                  numero: '1',
                  titulo: 'Análise',
                  descricao: 'Mapeamos seus processos atuais',
                },
                {
                  numero: '2',
                  titulo: 'Design',
                  descricao: 'Criamos sistema customizado',
                },
                {
                  numero: '3',
                  titulo: 'Implementação',
                  descricao: 'Integramos e testamos',
                },
                {
                  numero: '4',
                  titulo: 'Treinamento',
                  descricao: 'Você aprende a usar e otimizar',
                },
              ].map((step, i) => (
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-[#0A2540] to-[#1F2933] text-white">
          <div className="container text-center">
            ...
            <p className="text-xl mb-8 text-gray-300">
              Solicite um diagnóstico gratuito e veja como podemos ajudar
            </p>
